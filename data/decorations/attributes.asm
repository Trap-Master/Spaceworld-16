...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    4,              SET_UP_DOLL,       EVENT_DECO_PIKACHU_DOLL,         SPRITE_EEVEE
	decoration DECO_PLANT,   SURF_PIKA_DOLL, SET_UP_DOLL,       EVENT_DECO_SURFING_PIKACHU_DOLL, SPRITE_EEVEE
	decoration DECO_DOLL,    5,              SET_UP_DOLL,       EVENT_DECO_CLEFAIRY_DOLL,        SPRITE_EEVEE
	decoration DECO_DOLL,    6,              SET_UP_DOLL,       EVENT_DECO_JIGGLYPUFF_DOLL,      SPRITE_EEVEE
	decoration DECO_DOLL,    0,              SET_UP_DOLL,       EVENT_DECO_BULBASAUR_DOLL,       SPRITE_EEVEE
	decoration DECO_DOLL,    1,              SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,      SPRITE_EEVEE
	decoration DECO_DOLL,    2,              SET_UP_DOLL,       EVENT_DECO_SQUIRTLE_DOLL,        SPRITE_EEVEE
	decoration DECO_DOLL,    9,              SET_UP_DOLL,       EVENT_DECO_POLIWAG_DOLL,         SPRITE_EEVEE
	decoration DECO_DOLL,    8,              SET_UP_DOLL,       EVENT_DECO_DIGLETT_DOLL,         SPRITE_EEVEE
	decoration DECO_DOLL,    18,             SET_UP_DOLL,       EVENT_DECO_STARMIE_DOLL,         SPRITE_EEVEE
	decoration DECO_DOLL,    19,             SET_UP_DOLL,       EVENT_DECO_MAGIKARP_DOLL,        SPRITE_EEVEE
	decoration DECO_DOLL,    7,              SET_UP_DOLL,       EVENT_DECO_ODDISH_DOLL,          SPRITE_EEVEE
	decoration DECO_DOLL,    15,             SET_UP_DOLL,       EVENT_DECO_GENGAR_DOLL,          SPRITE_EEVEE
	decoration DECO_DOLL,    14,             SET_UP_DOLL,       EVENT_DECO_SHELLDER_DOLL,        SPRITE_EEVEE
	decoration DECO_DOLL,    13,             SET_UP_DOLL,       EVENT_DECO_GRIMER_DOLL,          SPRITE_EEVEE
	decoration DECO_DOLL,    17,             SET_UP_DOLL,       EVENT_DECO_VOLTORB_DOLL,         SPRITE_EEVEE
	decoration DECO_DOLL,    3,              SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,          SPRITE_EEVEE
	decoration DECO_DOLL,    22,             SET_UP_DOLL,       EVENT_DECO_UNOWN_DOLL,           SPRITE_EEVEE
	decoration DECO_DOLL,    12,             SET_UP_DOLL,       EVENT_DECO_GEODUDE_DOLL,         SPRITE_EEVEE
	decoration DECO_DOLL,    10,             SET_UP_DOLL,       EVENT_DECO_MACHOP_DOLL,          SPRITE_EEVEE
	decoration DECO_DOLL,    11,             SET_UP_DOLL,       EVENT_DECO_TENTACOOL_DOLL,       SPRITE_EEVEE
